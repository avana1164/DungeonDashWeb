class Player extends Entity {
    ...
    constructor(ds, keyH){
        ...
        super(ds);
        let projSpriteCounter, swordSpriteCounter, idleSpriteCounter, swordSpriteNum, swingSpeed, bladeCooldown;
        let attacking, projectileFiring, cooldownStarted;
        let walk5, walk6, sword1, sword2, sword3, sword4, idle5, idle6;
        this.keyH = keyH;
        let counter = 0;// delete later
 ...
 */
    ...
    update() {
        ...
        if (ds.keyH.yPressed == true && attacking == false && cooldownStarted == false) {
            ...
            let enemyIndex = ds.cChecker.checkEntity(this, ds.enemies);
    ...
    swordAttack() {
        ...
        if (swordSpriteCounter == 5) {
            let filepathSword = "src\\finalproject_dungeondash\\SwordSound.wav";// create a string for the filepath
            ...
            //cehck monster collision with updated player hitbox(sword hitbox)
             enemyIndex = ds.cChecker.checkEntity(this, ds.enemies);
    ...
    drawPlayer(g2d) {
        ...
        if (invincible == true) {
            g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.7)); //player becomes somewhat transparent when invincible
        }
